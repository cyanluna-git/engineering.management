...
import type { PortalService } from "@/config/services";
...
export function ServiceCard({ service }: ServiceCardProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative flex h-14 w-14 items-center justify-center rounded-2xl text-white shadow-sm ring-1 ring-black/5",
          service.color,
        )}
      >
